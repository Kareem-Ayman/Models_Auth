...
return [
  ...
  ":trialDays Day Trial" => ":TrialDays يوم تجريبي",
  ...
  "Action" => "الإجراء",
  "Action Button Text" => "نص زر الحدث",
  "Action Button URL" => "رابط زر الحدث",
  ...
  "Added." => "تمت الإضافة.",
  "Additional billing information updated successfully." => "تم تحديث معلومات الفوترة الإضافية بنجاح.",
  "Address" => "العنوان",
  "Address Line 2" => "العنوان 2",
  "Administrator" => "المدير",
  "Administrator users can perform any action." => "المدراء بإمكانهم تنفيذ أي إجراء.",
  "Afghanistan" => "أفغانستان",
  "After logging in via your emergency token, two-factor authentication will be disabled for your account. If you would like to maintain two-factor authentication security, you should re-enable it after logging in." => "بعد تسجيل الدخول عبر رمز الطوارئ الخاص بك، سيتم تعطيل المصادقة الثنائية لحسابك. إذا كنت ترغب في الحفاظ على أمان المصادقة الثنائية، يجب عليك إعادة تمكينه بعد تسجيل الدخول.",
  "Alabama" => "ألاباما",
  ...
  "All subscription plan prices are excluding applicable VAT." => "جميع أسعار خطط الإشتراك لا تشمل ضريبة القيمة المضافة المطبقة.",
  "All subscription plan prices include applicable VAT." => "جميع أسعار خطط الإشتراك تشمل ضريبة القيمة المضافة المطبقة.",
  ...
  "An error occurred while uploading the file: :error" => "حدث خطأ أثناء تحميل الملف: :error",
  ...
  "Announcements you create here will be sent to the \"Product Announcements\" section of the notifications modal window, informing your users about new features and improvements to your application." => "الإعلانات التي قمت بإنشائها هنا سيتم إرسالها إلى قسم \"إعلانات المنتج\" في نافذة نموذج الإشعارات لإعلام المستخدمين بالميزات الجديدة والتحسينات التي تم إدخالها على تطبيقك.",
  ...
  "Applying" => "تطبيق",
  "April" => "أبريل",
  "Are you sure you want to attempt to pay :amount?" => "هل أنت متأكد من أنك تريد محاولة الدفع: amount؟",
  "Are you sure you want to cancel your subscription?" => "هل أنت متأكد من رغبتك بإلغاء اشتراكك؟",
  "Are you sure you want to delete the selected resources?" => "هل أنت متأكد من رغبتك بحذف هذه المصادر؟",
  "Are you sure you want to delete this announcement?" => "هل أنت متأكد من رغبتك بحذف هذا الإعلان؟",
  ...
  "Are you sure you want to delete this payment method?" => "هل أنت متأكد من رغبتك بحذف طريقة الدفع هذه؟",
  ...
  "Are you sure you want to delete this token? If deleted, API requests that attempt to authenticate using this token will no longer be accepted." => "هل أنت متأكد من رغبتك في حذف هذا الرمز؟ إذا قمت بحذفه، لن يتم قبول طلبات API التي تحاول المصادقة باستخدام هذا الرمز.",
  ...
  "Are you sure you want to resume your subscription?" => "هل أنت متأكد من رغبتك باستئناف اشتراكك؟",
  "Are you sure you want to run this action?" => "هل أنت متأكد من رغبتك بتنفيذ هذا الإجراء؟",
  "Are you sure you want to set this payment method as your default?" => "هل أنت متأكد من رغبتك بتعيين طريقة الدفع هذه كإعداد افتراضي؟",
  "Are you sure you want to stop impersonating?" => "هل أنت متأكد من رغبتك بالتوقف عن انتحال الهوية؟",
  "Are you sure you want to switch to the :planName plan?" => "هل أنت متأكد أنك تريد التبديل إلى الخطة :planName؟",
  ...
  "Are you sure you would like to switch billing plans?" => "هل أنت متأكد من رغبتك بتبديل خطط الفوترة؟",
  "Argentina" => "الأرجنتين",
  "Arizona" => "أريزونا",
  "Arkansas" => "اركانساس",
  "Armed Forces Africa / Canada / Europe / Middle East" => "لقوات المسلحة أفريقيا / كندا / أوروبا / الشرق الأوسط",
  "Armed Forces America (Except Canada)" => "القوات المسلحة الأمريكية (باستثناء كندا)",
  "Armed Forces Pacific" => "القوات المسلحة المحيط الهادئ",
  "Armenia" => "أرمينيا",
  "Aruba" => "أروبا",
  "Assign All Abilities" => "تعيين كافة القدرات",
  "Attach" => "إرفاق",
  "Attach & Attach Another" => "إرفاق وإضافة مرفق آخر",
  "Attach :resource" => "إرفاق :resource",
  "Attach files by dragging & dropping, selecting or pasting them." => "إرفاق الملفات عبر سحبهم وإفلاتهم، اختيارهم، أو لصقهم.",
  "Attendance" => "حضور",
  "August" => "أغسطس",
  "Australia" => "أستراليا",
  "Austria" => "النمسا",
  ...
  "Click here to reset your password:" => "اضغط هنا لإعادة تعيين كلمة المرور الخاصة بك:",
  ...
  "Comoros" => "جزر القمر",
  "Confirm" => "تأكيد",
  "Confirm Billing Action" => "تأكيد إجراء الفوترة",
  ...
  "Coupon" => "الكوبون",
  "Coupon accepted! The discount will be applied to your next invoice." => "تم قبول الكوبون! سيتم تطبيق الخصم في فاتورتك التالية.",
  ...
  "Excel (.xlsx)" => "إكسيل (.xlsx)",
  "Expiration" => "انتهاء الصلاحية",
  "Expires :expiration" => "تنتهي في :expiration",
  ...
  "Finland" => "فنلندا",
  "Florida" => "فلوريدا",
  "For security reasons your new card will be charged a minimal fee upon registration." => "لأسباب أمنية، سيتم فرض رسوم رمزية على بطاقتك الجديدة عند التسجيل.",
  ...
  "Go back" => "عودة",
  "Go Home" => "الرئيسية",
  "Go To Login" => "الإنتقال إلى صفحة تسجيل الدخول",
  ...
  "Hello!" => "أهلاً بك!",
  "Here is your new API token." => "ها هو رمز API الجديد الخاص بك.",
  "Hi :name" => "مرحباً :name",
  "Hi!" => "مرحباً!",
  ...
  "Hong Kong" => "هونغ كونغ",
  "Hungary" => "هنغاريا",
  "I Accept :linkOpen The Terms Of Service :linkClose" => "أوافق على :linkOpen شروط الخدمة :linkClose",
  ...
  "If you did not expect to receive an invitation to this team, you may discard this email." => "إذا لم تتوقع تلقي دعوة إلى هذا الفريق، فيمكنك تجاهل هذا البريد الإلكتروني.",
  ...
  "If you do not already have an account, you may click the following link to get started:" => "إذا لم يكن لديك حساب بالفعل، يمكنك النقر فوق الرابط التالي للبدء:",
  "If you do not have an account, you may create one by clicking the button below. After creating an account, you may click the invitation acceptance button in this email to accept the team invitation:" => "إذا لم يكن لديك حساب، يمكنك إنشاء حساب بالضغط على الزر أدناه. بعد إنشاء حساب، يمكنك الضغط على زر قبول الدعوة في هذا البريد الإلكتروني لقبول دعوة الفريق:",
  "If you lose your two-factor authentication device, you may use this emergency reset token to disable two-factor authentication on your account." => "إذا فقدت جهاز المصادقة الثنائية، يمكنك استخدام رمز إعادة تعيين الطوارئ هذا لتعطيل المصادقة الثنائية على حسابك.",
  ...
  "In order to use two-factor authentication, you must install the :authyLink application on your smartphone. Authy is available for iOS and Android." => "من أجل استخدام المصادقة الثنائية، يجب عليك تثبيت :authyLink على هاتفك الذكي. Authy متاح لكل من iOS و Android.",
  "Increase" => "زيادة",
  "India" => "الهند",
  "Indiana" => "إنديانا",
  "Indonesia" => "إندونيسيا",
  ...
  "Logout" => "تسجيل الخروج",
  "Logout Other Browser Sessions" => "تسجيل الخروج من جلساتك على المتصفحات الأخرى",
  "Logs" => "السجلات",
  ...
  "Madagascar" => "مدغشقر",
  "Mailed Invitations" => "الدعوات المرسلة بالبريد",
  "Maine" => "ماين",
  "Malawi" => "ملاوي",
  "Malaysia" => "ماليزيا",
  ...
  "Manage and logout your active sessions on other browsers and devices." => "إدارة جلساتك النشطة والخروج منها على المتصفحات والأجهزة الأخرى.",
  ...
  "Next Payment on" => "الدفع القادم بتاريخ",
  "Nicaragua" => "نيكاراغوا",
  "Niger" => "النجير",
  "Nigeria" => "نيجيريا",
  "Niue" => "نيوي",
  ...
  "No customer support request recipient is defined." => "لم يتم تعريف مستلم طلب دعم العملاء.",
  "No Data" => "ﻻ توجد بيانات",
  "no file selected" => "لم يتم اختيار ملف",
  "No Increase" => "لا توجد زيادة",
  "No payment methods on file." => "لا توجد طرق دفع في الملف.",
  "No payment scheduled." => "لا توجد دفعة مجدولة.",
  "No Prior Data" => "لا توجد بيانات سابقة",
  "No Results Found." => "لم يتم العثور على نتائج.",
  "No users matched the given criteria." => "لم تنطبق المعايير المحددة على أي مستخدمين.",
  "No, Go Back" => "لا، العودة للخلف",
  "None" => "بدون",
  "Norfolk Island" => "جزيرة نورفولك",
  "North Carolina" => "شمال كارولينا",
  "North Dakota" => "شمال داكوتا",
  "Northern Mariana Islands" => "جزر ماريانا الشمالية",
  "Northwest Territories" => "الاقاليم الشمالية الغربية",
  "Norway" => "النرويج",
  "Not Found" => "غير متوفر",
  "Notifications" => "الإشعارات",
  "Nova" => "Nova",
  "Nova Scotia" => "سكوتيا الجديدة",
  ...
  "Our billing management portal allows you to conveniently manage your subscription plan, payment methods, and download your recent invoices." => "تتيح لك بوابة إدارة الفواتير الخاصة بنا إدارة خطة الاشتراك الخاصة بك، طرق الدفع، وتنزيل فواتيرك الحديثة.",
  "Owner" => "المالك",
  ...
  "Payment information updated successfully." => "تم تحديث معلومات الدفع بنجاح.",
  ...
  "Please :linkOpen confirm your payment :linkClose to activate your subscription!" => "الرجاء :linkOpen تأكيد عملية الدفع :linkClose لتفعيل اشتراكك!",
  ...
  "Please first register your billing address." => "يرجى أولاً تسجيل عنوان الفواتير الخاص بك.",
  "Please first register your team's billing address." => "يرجى أولاً تسجيل عنوان الفواتير الخاص بفريقك.",
  ...
  "Please provide the email address of the person you would like to add to this team. The email address must be associated with an existing account." => "يرجى إدخال عنوان البريد الإلكتروني للشخص الذي ترغب في إضافته إلى هذا الفريق. يجب أن يكون عنوان البريد الإلكتروني مرتبطًا بحساب موجود",
  "Please provide your name." => "يرجى تزويدنا بإسمك.",
  "Please select at least one ability." => "الرجاء تحديد قدرة واحدة على الأقل.",
  "Please set a default payment method before swapping plans." => "يرجى تعيين طريقة الدفع الافتراضية قبل تبديل الخطط.",
  ...
  "Previewing" => "معاينة",
  "Previous" => "السابق",
  "Prince Edward Island" => "جزيرة الأمير ادوارد",
  ...
  "Quebec" => "كيبيك",
  "Receipt Email Addresses" => "عناوين البريد الإلكتروني للإيصالات",
  "Receipt emails updated successfully." => "تم تحديث عناوين البريد الإلكتروني للإيصالات بنجاح.",
  "Receipts" => "الإيصالات",
  ...
  "Save" => "حفظ",
  "Saved." => "تم الحفظ.",
  "Scroll to bottom" => "الإنتقال للأسفل",
  "Scroll to top" => "الإنتقال للأعلى",
  "Search" => "بحث",
  "Search By Name Or E-Mail Address..." => "البحث بالاسم أو عنوان البريد الإلكتروني...",
  "Search Results" => "نتائج البحث",
  "Searching" => "جاري البحث",
  "second address line" => "العنوان الثاني",
  "Security" => "الحماية",
  "Security Code" => "رمز الحماية",
  "See you soon!" => "نراك قريباً!",
  "Select" => "اختر",
  "Select a different plan" => "اختر خطة مختلفة",
  "Select a log file..." => "اختر ملف السجل...",
  ...
  "Since you already have an account, you may accept the invitation from your account settings screen." => "نظرًا لأن لديك حساب بالفعل، يمكنك قبول الدعوة من شاشة إعدادات حسابك.",
  "Singapore" => "سنغافورة",
  ...
  "Something went wrong." => "هناك خطأ ما.",
  "Something went wrong. Please try again or contact customer support." => "هناك خطأ ما. يرجى المحاولة مرة أخرى أو الاتصال بدعم العملاء.",
  ...
  "Start polling" => "بدء التصويت",
  "State" => "الولاية",
  "State & ZIP / Postal Code" => "الولاية / الرمز البريدي",
  ...
  "Thanks for your continued support. We've attached a copy of your invoice for your records. Please let us know if you have any questions or concerns!" => "شكرا لدعمكم المتواصل. لقد أرفقنا نسخة من فاتورتك لسجلاتك. يرجى إعلامنا إذا كان لديك أي أسئلة أو مخاوف!",
  "Thanks for your continued support. We've attached a copy of your invoice for your records. Please let us know if you have any questions or concerns." => "شكرا لدعمكم المتواصل. لقد أرفقنا نسخة من فاتورتك لسجلاتك. يرجى إعلامنا إذا كان لديك أي أسئلة أو مخاوف.",
  "Thanks!" => "شكراً!",
  "Thanks," => "شكراً،",
  ...
  "The benefits of your subscription will continue until your current billing period ends on :date. You may resume your subscription at no extra cost until the end of the billing period." => "ستستمر فوائد اشتراكك حتى انتهاء دورة الفوترة الحالية في :date. يمكنك استئناف اشتراكك دون أي تكلفة إضافية حتى نهاية دورة الفوترة.",
  "The coupon :value discount will be applied to your subscription!" => "سيتم تطبيق خصم الكوبون :value على اشتراكك!",
  "The default payment method cannot be removed." => "لا يمكن إزالة طريقة الدفع الافتراضية.",
  "The emergency token was invalid." => "رمز الطوارئ غير صالح.",
  ...
  "The given password does not match our records." => "كلمة المرور المحددة لا تتطابق مع سجلاتنا.",
  ...
  "These people have been invited to your team and have been sent an invitation email. They may join the team by accepting the email invitation." => "تمت دعوة هؤلاء الأشخاص إلى فريقك وتم إرسال دعوة عبر البريد الإلكتروني إليهم. يمكنهم الإنضمام إلى الفريق عن طريق قبول دعوة البريد الإلكتروني.",
  ...
  "This country does not match the origin country of your card." => "هذا البلد لا يتطابق مع البلد الأصلي لبطاقتك.",
  "This coupon code can only be used by new customers." => "يسمح باستخدام هذا الكوبون من قبل العملاء الجدد فقط.",
  "This coupon code is invalid." => "رمز الكوبون غير صالح.",
  "This device" => "هذا الجهاز",
  "This file field is read-only." => "حقل الملف هذا للقراءة فقط.",
  "This image" => "هذه الصورة",
  "This information will appear on all of your receipts, and is a great place to add your full business name, VAT number, or address of record. Do not include any confidential or financial information such as credit card numbers." => "ستظهر هذه المعلومات في جميع الإيصالات الخاصة بك، وهي مكان رائع لإضافة اسم عملك الكامل أو رقم ضريبة القيمة المضافة أو عنوان السجل. لا تقم بتضمين أي معلومات سرية أو مالية مثل أرقام بطاقات الائتمان.",
  "This invitation code is invalid." => "رمز الدعوة هذا غير صالح.",
  "This invoice is no longer open." => "هذه الفاتورة لم تعد مفتوحة.",
  ...
  "This is the only time the token will ever be displayed, so be sure not to lose it!" => "سيتم عرض الرمز هذه المرة فقط، لذا تأكد من عدم فقدانه!",
  "This is the only time this token will be displayed, so be sure not to lose it!" => "سيتم عرض الرمز هذه المرة فقط، لذا تأكد من عدم فقدانه!",
  ...
  "This plan has been discontinued, but you may continue your subscription to this plan as long as you wish. If you cancel your subscription and later want to begin a new subscription, you will need to choose from one of the active plans listed below." => "تم إيقاف هذه الخطة، لكن بإمكانك متابعة اشتراكك في هذه الخطة طيلة رغبتك بذلك. إذا قمت بإلغاء الاشتراك الخاص بك وترغب لاحقًا في بدء اشتراك جديد، فستحتاج إلى الاختيار من بين الخطط النشطة المذكورة أدناه.",
  ...
  "This team has too many team members for the selected plan." => "هذا الفريق يضم الكثير من الأعضاء للخطة المختارة.",
  "This team is not eligible for this plan." => "هذا الفريق غير مؤهل لهذه الخطة.",
  "This user already belongs to the team." => "هذا المستخدم ينتمي بالفعل إلى الفريق.",
  "This user has a discount of :discountAmount for a single invoice." => "هذا المستخدم لديه خصم :discountAmount لفاتورة واحدة.",
  "This user has a discount of :discountAmount for all invoices during the next :months months." => "هذا المستخدم لديه خصم :discountAmount لجميع الفواتير خلال :months شهور القادمة.",
  "This user has a discount of :discountAmount for all invoices during the next month." => "هذا المستخدم لديه خصم :discountAmount لجميع الفواتير خلال الشهر القادم.",
  "This user has a discount of :discountAmount forever." => "هذا المستخدم لديه خصم :discountAmount للأبد.",
  ...
  "Togo" => "توغو",
  "Tokelau" => "توكيلو",
  "Token Can" => "يمكن للرمز",
  "Token Name" => "اسم الرمز",
  "Tonga" => "تونغا",
  "Too Many Requests" => "طلبات كثيرة جدًا",
  "total" => "الإجمالي",
  "Total Price Including Tax" => "السعر الإجمالي شاملاً الضريبة",
  "Total Revenue" => "إجمالي الإيرادات",
  "Total Volume" => "القيمة الإجمالية",
  "Total:" => "الإجمالي:",
  "Trashed" => "محذوف",
  "Trial" => "تجريبي",
  "Trialing" => "جاري التجربة",
  ...
  "Two factor authentication is now enabled. Scan the following QR code using your phone's authenticator application." => "لقد تم تمكين المصادقة الثنائية لحسابك. قم بمسح رمز الاستجابة السريعة التالي باستخدام تطبيق المصادقة بهاتفك.",
  "Two-Factor Authentication" => "المصادقة الثنائية",
  "Two-Factor Authentication Reset Code" => "رمز استعادة المصادقة الثنائية",
  "Type" => "النوع",
  "Uganda" => "أوغندا",
  "Ukraine" => "أوكرانيا",
  ...
  "Update Billing Address" => "تحديث عنوان الفوترة",
  "Update Password" => "تحديث كلمة المرور",
  "Update Payment Information" => "تحديث معلومات الدفع",
  "Update Payment Method" => "تحديث طريقة الدفع",
  "Update Photo" => "تحديث الصورة",
  "Update Subscription" => "تحديث الإشتراك",
  "Update VAT ID" => "تحديث معرّف الضريبة المضافة",
  ...
  "Users" => "المستخدمين",
  "Users Currently Trialing" => "المستخدمين قيد التجربة حاليا",
  "Utah" => "يوتا",
  "Uzbekistan" => "أوزبكستان",
  "Value" => "القيمة",
  "Vanuatu" => "فانواتو",
  "VAT ID" => "معرّف الضريبة المضافة",
  ...
  "We don't have anything to show you right now! But when we do, we'll be sure to let you know. Talk to you soon!" => "ليس لدينا أي شيء لعرضه الآن! ولكن عندما نفعل، سنكون متأكدين من إخبارك بذلك. سنخطرك قريبا!",
  "We had trouble updating your billing address. Please contact customer support." => "واجهنا مشكلة في تحديث عنوان الفوترة الخاص بك. يرجى الاتصال بدعم العملاء.",
  "We had trouble updating your card. It's possible your card provider is preventing us from charging the card. Please contact your card provider or customer support." => "واجهنا مشكلة في تحديث بطاقتك. من الممكن أن يمنعنا مزود بطاقتك من شحن البطاقة. يرجى الاتصال بمزود بطاقتك أو دعم العملاء.",
  "We had trouble updating your payment method. It's possible your payment provider is preventing us from charging the payment method. Please contact your payment provider or customer support." => "واجهنا مشكلة في تحديث طريقة الدفع الخاصة بك. من الممكن أن يمنعنا مزود الدفع الخاص بك من فرض رسوم الدفع. يرجى الاتصال بمزود الدفع أو دعم العملاء.",
  "We had trouble validating your card. It's possible your card provider is preventing us from charging the card. Please contact your card provider or customer support." => "واجهنا مشكلة في التحقق من صحة بطاقتك. من الممكن أن يمنعنا مزود بطاقتك من شحن البطاقة. يرجى الاتصال بمزود بطاقتك أو دعم العملاء.",
  "We have emailed your password reset link!" => "قمنا بإرسال رابط إعادة تعيين كلمة المرور إلى بريدك الإلكتروني!",
  "We have received your message and will respond soon!" => "لقد تلقينا رسالتك وسوف نرد عليك قريباً!",
  "We were not able to enable two-factor authentication for this phone number." => "لم نتمكن من تمكين المصادقة الثنائية لرقم الهاتف هذا.",
  ...
  "We were unable to update your subscription. Please contact customer support." => "لم نتمكن من تحديث اشتراكك. يرجى الاتصال بدعم العملاء.",
  ...
  "Welcome to your new subscription." => "مرحبًا بك في اشتراكك الجديد.",
  ...
  "Whoops! This coupon code is invalid." => "عذراً! رمز الكوبون هذا غير صالح.",
  "Whoops! This invitation code is invalid." => "عذراً! رمز الدعوة هذا غير صالح.",
  "Wisconsin" => "ويسكونسن",
  ...
  "Yearly" => "سنوي",
  "yearly" => "سنوي",
  "Yearly Recurring Revenue" => "الإيرادات السنوية المتكررة",
  "Yemen" => "اليمن",
  "Yes" => "نعم",
  "Yes, Cancel" => "نعم، ألغي",
  "Yes, Delete" => "نعم، أحذف",
  ...
  "You are currently subscribed to the :planName plan." => "أنت مشترك حالياً في الخطة :planName.",
  "You are currently within your free trial period. Your trial will expire on :date." => "أنت الآن ضمن الفترة التجريبية المجانية. ستنتهي فترتك التجريبية في :date.",
  "You are currently within your free trial period. Your trial will expire on :date. Starting a new subscription will end your trial." => "أنت الآن ضمن الفترة التجريبية المجانية. ستنتهي فترتك التجريبية في :date. بدء اشتراك جديد سيؤدي إلى إنهاء فترتك التجريبية.",
  "You are logged in!" => "لقد قمت بتسجيل الدخول!",
  "You are not eligible for this plan." => "أنت غير مؤهل لهذه الخطة.",
  ...
  "You currently have :count invitation(s) remaining." => "أنت تملك حالياً :count دعوة/دعوات متبقية.",
  "You currently receive a discount of :discountAmount for a single invoice." => "لقد تلقيت خصماً قدره :discountAmount لفاتورة واحدة.",
  "You currently receive a discount of :discountAmount for all invoices during the next :months billing cycles." => "لدق تلقيت خصماً قدره :discountAmount لجميع الفواتير خلال دورات الفوترة الـ :months القادمة.",
  "You currently receive a discount of :discountAmount for all invoices during the next :months months." => "لدق تلقيت خصماً قدره :discountAmount لجميع الفواتير خلال :months شهور القادمة.",
  "You currently receive a discount of :discountAmount for all invoices during the next billing cycle." => "لدق تلقيت خصماً قدره :discountAmount لجميع الفواتير خلال دورة الفوترة القادمة.",
  "You currently receive a discount of :discountAmount for all invoices during the next month." => "لدق تلقيت خصماً قدره :discountAmount لجميع الفواتير خلال الشهر القادم.",
  "You currently receive a discount of :discountAmount forever." => "لدق تلقيت خصماً قدره :discountAmount للأبد.",
  "You have been invited to join the :team team!" => "لقد تمت دعوتك للإنضمام إلى فريق :team!",
  "You have cancelled your subscription to the :planName plan." => "لقد قمت بإلغاء اشتراكك من الخطة :planName.",
  ...
  "You have some unpaid invoices. After updating your default payment method, you may retry the payments via the invoice list below." => "لديك بعض الفواتير غير المدفوعة. بعد تحديث طريقة الدفع الافتراضية الخاصة بك، يمكنك إعادة محاولة الدفع عبر قائمة الفواتير أدناه.",
  ...
  "You may revoke the token at any time from your API settings." => "يمكنك إلغاء الرمز في أي وقت من إعدادات API.",
  "You will be redirected to Mollie's checkout." => "سيتم إعادة توجيهك إلى عملية الدفع بواسطة Mollie.",
  "You will receive an invoice and payment link via email for each billing period." => "سوف تتلقى رابط الفاتورة والدفع عبر البريد الإلكتروني لكل دورة فوترة.",
  "You're logged in!" => "لقد قمت بتسجيل الدخول!",
  "Your :invoiceName invoice is now available!" => "فاتورتك :invoiceName متاحة حاليا!",
  "Your application's dashboard." => "لوحة معلومات التطبيق الخاصة بك",
  "Your billing address has been updated!" => "تم تحديث عنوان الفوترة الخاص بك!",
  "Your billing address is :address :address2 :postal_code :city :state :country" => "عنوان الفوترة الخاص بك هو :address :address2 :postal_code :city :state :country",
  "Your billing information has been updated!" => "تم تحديث معلومات الفوترة الخاص بك!",
  ...
  "Your contact information has been updated!" => "تم تحديث معلومات التواصل الخاصة بك!",
  "Your current payment method is :paypal." => "طريقة الدفع الخاصة بك حالياً هي :paypal.",
  "Your current payment method is a credit card ending in :lastFour that expires on :expiration." => "طريقك الدفع الخاصة بك حاليا هي بطاقة ائتمانية آخرها :lastFour وتنتهي فترة صلاحيتها في :expiration.",
  ...
  "Your next payment of :amount will be processed on :date." => "دفعتك القادمة وقيمتها :amount ستكون في :date.",
  "Your password has been updated!" => "تم تحديث كلمة المرور الخاصة بك!",
  "Your payment method could not be updated." => "لا يمكن تحديث طريقة الدفع الخاصة بك.",
  "Your payment method has been added successfully." => "تمت إضافة طريقة الدفع الخاصة بك بنجاح.",
  "Your payment method has been updated." => "تم تحديث طريقة الدفع الخاصة بك.",
  "Your payment method will be charged automatically for each billing period." => "سيتم السداد باستخدام طريقة الدفع الخاصة بك تلقائيًا لكل دورة فوترة.",
  "Your payment went wrong. Try again or contact support" => "لم نتمكن من إتمام عملية الدفع. حاول مرة أخرى أو اتصل بالدعم",
  ...
  "Your subscription has been started successfully." => "لقد بدأ اشتراكك بنجاح.",
  "Your subscription has been successfully cancelled." => "تم إلغاء اشتراكك بنجاح.",
  "Your subscription was successfully resumed." => "تم استئناف اشتراكك بنجاح.",
  "Your subscription was successfully updated." => "تم تحديث اشتراكك بنجاح.",
  "Your trial period will expire on " => "ستنتهي الفترة التجريبية الخاصة بك في",
  "Your VAT ID has been updated!" => "تم تحديث معرّف الضريبة المضافة الخاص بك!",
  "yr" => "سنة",
  "Yukon" => "يوكون",
  "Zambia" => "زامبيا",
  "Zimbabwe" => "زيمبابوي",
